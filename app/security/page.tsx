  ...
  return (
    <main className="min-h-screen bg-white dark:bg-black text-black dark:text-black dark:text-white">
      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        <h1 className="text-3xl font-bold mb-6 text-black dark:text-white">Security & Compliance</h1>
        ...
        <div className="space-y-6 text-sm text-gray-600 dark:text-gray-400 leading-relaxed max-w-3xl">
          ...
          <section>
            <h2 className="text-xl font-bold mb-3 text-black dark:text-white">Certifications</h2>
          ...
          <section>
            <h2 className="text-xl font-bold mb-3 text-black dark:text-white">Data Protection</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold mb-3 text-black dark:text-white">Infrastructure Security</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold mb-3 text-black dark:text-white">Audit Logging</h2>
            <p>
