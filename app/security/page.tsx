  ...
  return (
    <main className="min-h-screen bg-black text-white">
      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        <h1 className="text-3xl font-bold mb-6 text-white">Security & Compliance</h1>
        ...
        <div className="space-y-6 text-sm text-gray-400 leading-relaxed max-w-3xl">
          ...
          <section>
            <h2 className="text-xl font-bold mb-3 text-white">Data Protection</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold mb-3 text-white">Infrastructure Security</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold mb-3 text-white">Audit Logging</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold mb-3 text-white">Report a Vulnerability</h2>
            <p>
