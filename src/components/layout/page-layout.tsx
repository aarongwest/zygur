  ...
  return (
    <div className="flex">
      ...
      <div className="flex-1 min-h-screen text-zinc-100 relative">
        ...
        <div className="absolute top-0 left-0 right-0 h-[850px] bg-[url('/911-inspiration.png')] bg-cover bg-[center_top_-100px] z-0">
          {/* Extended gradient overlay that fades the bottom of the image */}
          <div className="absolute inset-0 bg-gradient-to-b from-dark-green/70 via-dark-green/50 to-black/90 z-0"></div>
