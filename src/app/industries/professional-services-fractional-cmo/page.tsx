          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
            ...
            <div className="bg-dark-green/60 rounded-lg p-8">
              ...
              <div className="space-y-6">
                <div>
                  <h3 className="text-lg font-semibold mb-2 text-accent-orange">Differentiation in Crowded Markets</h3>
                ...
                <div>
                  <h3 className="text-lg font-semibold mb-2 text-accent-orange">Lead Generation Beyond Referrals</h3>
                  <p className="text-zinc-300">
                ...
                <div>
                  <h3 className="text-lg font-semibold mb-2 text-accent-orange">Marketing-BD Integration</h3>
                  <p className="text-zinc-300">
                ...
                <div>
                  <h3 className="text-lg font-semibold mb-2 text-accent-orange">Measuring Marketing ROI</h3>
                  <p className="text-zinc-300">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-dark-green/60 rounded-lg p-6">
                ...
                <p className="text-zinc-300">
                  ...
                  <Link href="/services/strategy" className="text-accent-orange hover:underline"> Learn more about our strategic planning process.</Link>
                </p>
              </div>
              ...
              <div className="bg-dark-green/60 rounded-lg p-6">
                ...
                <p className="text-zinc-300">
                  ...
                  <Link href="/compare/fractional-cmo-vs-agency" className="text-accent-orange hover:underline"> See how our approach differs from traditional agencies.</Link>
                </p>
              </div>
            </div>
          </div>
