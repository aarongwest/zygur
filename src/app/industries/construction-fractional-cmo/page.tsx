          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
            ...
            <div className="bg-zinc-800/50 rounded-lg p-8">
              ...
              <div className="space-y-6">
                <div>
                  <h3 className="text-lg font-semibold mb-2 text-neon-green">Project-Based Revenue Cycles</h3>
                ...
                <div>
                  <h3 className="text-lg font-semibold mb-2 text-neon-green">Skilled Labor Shortages</h3>
                  <p className="text-zinc-300">
                ...
                <div>
                  <h3 className="text-lg font-semibold mb-2 text-neon-green">Undifferentiated Positioning</h3>
                  <p className="text-zinc-300">
                ...
                <div>
                  <h3 className="text-lg font-semibold mb-2 text-neon-green">Ineffective Digital Presence</h3>
                  <p className="text-zinc-300">
