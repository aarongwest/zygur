        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
            <div className="bg-zinc-800/50 rounded-lg p-8">
              ...
              <p className="text-zinc-300 mb-4">
                As your <Link href="/resources/what-is-a-fractional-cmo" className="text-neon-green hover:underline">fractional CMO</Link>, I bring extensive experience in:
              </p>
            ...
            <div className="bg-zinc-800/50 rounded-lg p-8">
              ...
              <div className="space-y-6">
                <div>
                  <h3 className="text-lg font-semibold mb-2 text-neon-green">Poor CAC to LTV Ratio</h3>
                ...
                <div>
                  <h3 className="text-lg font-semibold mb-2 text-neon-green">High Churn Rate</h3>
                  <p className="text-zinc-300">
                ...
                <div>
                  <h3 className="text-lg font-semibold mb-2 text-neon-green">Inconsistent Lead Quality</h3>
                  <p className="text-zinc-300">
                ...
                <div>
                  <h3 className="text-lg font-semibold mb-2 text-neon-green">Scaling Marketing Operations</h3>
                  <p className="text-zinc-300">
          ...
          <div className="bg-zinc-800/50 rounded-lg p-8 mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-zinc-900/50 p-6 rounded-lg">
                <div className="h-12 w-12 rounded-full bg-neon-green/20 flex items-center justify-center mb-4 text-neon-green font-bold">1</div>
              ...
              <div className="bg-zinc-900/50 p-6 rounded-lg">
                <div className="h-12 w-12 rounded-full bg-neon-green/20 flex items-center justify-center mb-4 text-neon-green font-bold">2</div>
              ...
              <div className="bg-zinc-900/50 p-6 rounded-lg">
                <div className="h-12 w-12 rounded-full bg-neon-green/20 flex items-center justify-center mb-4 text-neon-green font-bold">3</div>
            ...
            <div className="space-y-6">
              <div className="bg-zinc-800/50 rounded-lg p-6">
                ...
                <p className="text-zinc-300">
                  ...
                  <Link href="/pricing/fractional-cmo-cost" className="text-neon-green hover:underline"> View detailed pricing information.</Link>
                </p>
              </div>
              ...
              <div className="bg-zinc-800/50 rounded-lg p-6">
                ...
                <p className="text-zinc-300">
                  ...
                  <Link href="/industries/fractional-cmo-for-startups" className="text-neon-green hover:underline"> Learn more about my startup marketing services.</Link>
                </p>
              </div>
            </div>
          </div>
