        ...
        <div className="container mx-auto px-4">
          ...
          <div className="space-y-8 mb-16">
            <Link
              ...
              className="block bg-zinc-800/50 rounded-lg p-8 hover:bg-zinc-800 transition-colors group"
            >
          ...
          <div className="max-w-4xl mx-auto mb-16">
            ...
            <p className="text-zinc-400 mb-8">
              All service plans include a <span className="text-neon-green font-semibold">free $5,000 value website</span> and a <span className="text-neon-green font-semibold">$2,000 value branding package</span>. A 1-year minimum agreement is required for all plans.
            </p>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-gradient-to-b from-neon-green/20 to-zinc-800/50 rounded-lg p-6 relative">
                <div className="absolute top-3 right-3 bg-neon-green text-zinc-900 px-2 py-1 rounded-full text-xs font-medium">
                  Popular
                </div>
