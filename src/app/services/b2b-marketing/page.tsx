        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mb-16">
            ...
            <p className="text-lg text-zinc-400 mb-8">
              ...
              strategic marketing. As your <Link href="/" className="text-neon-green hover:underline">fractional CMO</Link>, 
          ...
          <div className="bg-zinc-800/50 rounded-lg p-8 mb-16">
            ...
            <div className="mb-8 pb-8 border-b border-zinc-700">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="md:col-span-2">
                  ...
                  <p className="text-zinc-400 mb-4">
                    As their <Link href="/" className="text-neon-green hover:underline">fractional CMO</Link>, I implemented:
                  </p>
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    <div className="bg-zinc-900/70 rounded-lg p-4 text-center">
                      <div className="text-3xl font-bold mb-1 text-blue-500">168%</div>
                      <p className="text-sm text-zinc-400">Increase in qualified leads</p>
                    </div>
                    <div className="bg-zinc-900/70 rounded-lg p-4 text-center">
                      <div className="text-3xl font-bold mb-1 text-blue-500">41%</div>
                      <p className="text-sm text-zinc-400">Shorter sales cycle</p>
                    </div>
                    <div className="bg-zinc-900/70 rounded-lg p-4 text-center">
                      <div className="text-3xl font-bold mb-1 text-blue-500">$875K</div>
            ...
            <div className="text-center">
              <Link href="/results" className="inline-flex items-center text-blue-500 hover:text-blue-400">
