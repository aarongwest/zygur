        ...
        <div className="container mx-auto px-4">
            ...
            <div className="flex flex-col md:flex-row gap-8">
              <div className="md:w-1/2">
                <p className="text-zinc-300 mb-6">
                  A <Link href="/resources/what-is-a-fractional-cmo" className="text-neon-green hover:underline">fractional CMO</Link> typically costs between <strong className="text-white">$2,000 and $7,000 per month</strong>, depending on 
              ...
              <div className="md:w-1/2 bg-zinc-900/50 rounded-lg overflow-hidden">
                ...
                <div className="p-6">
                  <div className="flex justify-between items-center py-4 border-b border-zinc-800">
                    ...
                    <span className="font-bold text-neon-green">$2,000 - $3,500</span>
                  </div>
                  <div className="flex justify-between items-center py-4 border-b border-zinc-800">
                    <span className="font-medium">Mid-Market Company</span>
                    <span className="font-bold text-neon-green">$3,500 - $5,000</span>
                  </div>
                  <div className="flex justify-between items-center py-4">
                    <span className="font-medium">Growth-Stage/Enterprise</span>
                    <span className="font-bold text-neon-green">$5,000 - $7,000+</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="mb-16">
            ...
            <div className="flex items-center p-6 bg-zinc-900/50 rounded-lg">
              <div className="mr-4 text-neon-green flex-shrink-0">
          ...
          <div className="bg-gradient-to-r from-neon-green/20 to-blue-500/20 rounded-lg p-8">
            <div className="flex flex-col md:flex-row justify-between items-center">
              ...
              <Link href="/call">
                <Button className="w-full md:w-auto bg-zinc-900 hover:bg-zinc-800 text-white font-medium py-5 px-6">
