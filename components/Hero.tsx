    ...
    <section className="w-full py-16 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="max-w-5xl mx-auto">
          <div className="bg-white dark:bg-[#2a2a2a] rounded-lg overflow-hidden shadow-2xl border border-gray-300 dark:border-gray-700">
            {/* Terminal header - Mac style */}
            <div className="bg-white dark:bg-[#2a2a2a] px-4 py-3 flex items-center gap-2 border-b border-gray-300 dark:border-gray-700">
            ...
            {/* Terminal content */}
            <div className="p-6 font-mono h-[600px] overflow-auto bg-white dark:bg-[#2a2a2a]">
